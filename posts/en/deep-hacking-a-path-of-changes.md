...
title: "Deep Hacking: A Path of Changes"
...
description: "Discover the evolution of Deep Hacking from its beginnings in 2021 to becoming an international community platform. Learn about the changes, improvements and the new version built with Astro."
categories:
  - "miscellaneous"
draft: false
featured: true
...
It was a review of the eJPT, Deep Hacking didn't even exist at that time (not even as a thought). It was an article I published on my own Github Pages site (_sikumy.github.io_) made with Hugo. The page back then looked more or less like this:

![Personal Github Pages site with Hugo showing sikumy's initial blog](https://cdn.deephacking.tech/i/posts/deep-hacking-un-camino-de-cambios/deep-hacking-un-camino-de-cambios-1.avif)
...
![Public Notion notes about cybersecurity before Deep Hacking](https://cdn.deephacking.tech/i/posts/deep-hacking-un-camino-de-cambios/deep-hacking-un-camino-de-cambios-2.avif)
...
![LinkedIn post announcing the launch of Deep Hacking](https://cdn.deephacking.tech/i/posts/deep-hacking-un-camino-de-cambios/deep-hacking-un-camino-de-cambios-3.avif)

![Initial version of Deep Hacking on WordPress with 13 published articles](https://cdn.deephacking.tech/i/posts/deep-hacking-un-camino-de-cambios/deep-hacking-un-camino-de-cambios-4.avif)
...
![First Deep Hacking logo made with Photoshop](https://cdn.deephacking.tech/i/posts/deep-hacking-un-camino-de-cambios/deep-hacking-un-camino-de-cambios-5.avif)
...
![Current Deep Hacking logo with professional design](https://cdn.deephacking.tech/i/posts/deep-hacking-un-camino-de-cambios/deep-hacking-un-camino-de-cambios-6.avif)
...
- [Deep Hacking's GitHub (follow us!)](https://github.com/DeepHackingBlog)

Specifically, in the `content` repository you can find all the blog's articles:

![Deep Hacking content repository on GitHub](https://cdn.deephacking.tech/i/posts/deep-hacking-un-camino-de-cambios/deep-hacking-un-camino-de-cambios-7.avif)
