...
![Diagrama del orden de procesamiento LSDOU de las GPO](images/image-2.png)
...
![Pestaña Linked Group Policy Objects de la OU Crownlands](images/image-3.png)
...
![Diagrama de Block Inheritance y Enforced en GPO](images/image-4.png)
...
![Filtrado de seguridad predeterminado con Authenticated Users](images/image-5.png)
...
![Pestaña Delegation con permisos Apply Group Policy](images/image-6.png)
...
![Menú de preferencias de GPO](images/image-8.png)
...
![Configuración de equipo y usuario en GPO](images/image-7.png)
